...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^vega$': '<rootDir>/test/mocks/styleMock.ts',
    '^vega-lite$': '<rootDir>/test/mocks/styleMock.ts',
    '^vega-tooltip$': '<rootDir>/test/mocks/styleMock.ts',
    '^vega-interpreter/(.*)$': '<rootDir>/test/mocks/styleMock.ts',
  },
